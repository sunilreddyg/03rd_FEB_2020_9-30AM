...
public class Verify_multiple_Selection_Dropdown_Accepting_Deselection {
		...
		if(flag==true)
		{
			...
			State_Dropdown.selectByIndex(7);
					...
					if(Selection_Count==3)
					{
						...
						//Get All selectio Count after deselection
						int Dcount=State_Dropdown.getAllSelectedOptions().size();
						if(Dcount==2)
						{
							System.out.println("Dropdown allows deselection");
						}
						else
						{
							System.out.println("Failed to deselected options");
						}
